...
const emptyForm = () => ({
  ...
  goods_service_description: '', confirmation_name: '', delivery_from: null, delivery_to: null, last_delivery: 'N', is_cancellation: 'N'
})
...
function onIsCancellationChange() {
  // When switching to cancellation, clear positive amounts
