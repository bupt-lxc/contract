<template>
  ...
  >
    ...
    <el-table-column prop="sc_id" :label="$t('filter.scId')" width="130" sortable />
    <el-table-column prop="sc_no" :label="$t('filter.scNo')" width="130" sortable />
    <el-table-column prop="requester_name" :label="$t('filter.requesterName')" width="130" show-overflow-tooltip sortable />
