...
home: {
  ...
  gr: {
    ...
    requester: 'Requester',
    requesterId: 'Requester ID',
    estimated: 'Amt Excl. Tax',
    estimatedAmount: 'Amount (Excl. Tax)',
    conValue: 'Amount (Incl. Tax)',
    estAmount: 'Amt Excl. Tax',
    taxRate: 'Tax Rate',
    remark: 'Remark',
    created: 'Created',
    actions: 'Actions',
    ...
    enterConValue: 'Enter amount incl. tax (leave empty to auto-calculate from tax rate):',
    enterValidNumber: 'Enter a valid positive number',
    createdBy: 'Created By',
    invalidNumber: 'Enter a valid positive number',
    requesterRequired: 'Requester is required',
    estimatedAmountRequired: 'Amount (excl. tax) is required',
    confirm: 'Confirm',
